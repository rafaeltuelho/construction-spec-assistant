      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="card">
            ...
            {specDocument && !specDocument.processingComplete && (
              <div className="mt-4">
                <ProcessingStatus
                  type="document"
          ...
          <div className="card">
            ...
            {submittalDocument && !submittalDocument.processingComplete && (
              <div className="mt-4">
                <ProcessingStatus
                  type="document"
            ...
            {submittalDocument?.processingComplete && (
              <div className="mt-4 flex items-center space-x-2 text-green-600">
                ...
                <span className="text-sm font-medium">Submittal ready</span>
              </div>
            )}
          </div>
        </div>
