...
- **Storage**: MongoDB for facts/metadata, Qdrant for vectors, local filesystem for documents
- **Processing**: Docling for PDF extraction, LangChain/LangGraph for AI workflows
