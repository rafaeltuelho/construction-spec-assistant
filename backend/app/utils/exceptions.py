...
class FactExtractionError(ConstructionSpecAssistantError):
    ...
    def __init__(self, message: str, details: Optional[Dict[str, Any]] = None):
        super().__init__(
            message=message, status_code=500, error_code="FACT_EXTRACTION_ERROR", details=details
        )
...
class RetrievalError(ConstructionSpecAssistantError):
    ...
    def __init__(self, message: str, details: Optional[Dict[str, Any]] = None):
        super().__init__(
            message=message, status_code=500, error_code="RETRIEVAL_ERROR", details=details
        )
...
class ComparisonError(ConstructionSpecAssistantError):
    ...
    def __init__(self, message: str, details: Optional[Dict[str, Any]] = None):
        super().__init__(
            message=message, status_code=500, error_code="COMPARISON_ERROR", details=details
        )
...
class DatabaseConnectionError(DatabaseError):
    ...
    def __init__(self, database: str, message: str):
        super().__init__(
            message=f"Failed to connect to {database}: {message}", details={"database": database}
        )
...
class LLMError(ConstructionSpecAssistantError):
    ...
    def __init__(self, message: str, details: Optional[Dict[str, Any]] = None):
        super().__init__(message=message, status_code=500, error_code="LLM_ERROR", details=details)
...
class LLMRateLimitError(LLMError):
    ...
    def __init__(self, provider: str):
        super().__init__(
            message=f"Rate limit exceeded for {provider}", details={"provider": provider}
        )
...
class LLMResponseParsingError(LLMError):
    ...
    def __init__(self, message: str):
        super().__init__(message=f"Failed to parse LLM response: {message}")
