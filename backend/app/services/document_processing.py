...
from app.core.chunker import chunk_sections, get_chunk_statistics
...
async def process_document(
    ...
    logger.info(f"Starting document processing: {doc_title} ({document_id})")
    ...
    try:
        ...
        # Step 2: Sectionize markdown
        logger.info(f"[{document_id}] Step 2: Sectionizing markdown")
        ...
        logger.info(f"[{document_id}] Step 3: Chunking sections")
